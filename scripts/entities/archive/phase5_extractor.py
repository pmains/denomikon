#!/usr/bin/env python3
"""
phase5_extractor.py — Pattern-based event extraction from Meeting Result docs.
...
Usage:
    PYTHONPATH=scripts python3 scripts/entities/phase5_extractor.py
    PYTHONPATH=scripts python3 scripts/entities/phase5_extractor.py --dry-run
    PYTHONPATH=scripts python3 scripts/entities/phase5_extractor.py --limit 100
"""
...
log = logging.getLogger("phase5_extractor")

WATERMARK_TABLE = "_phase5_extractor_watermark"
BATCH_SIZE = 50

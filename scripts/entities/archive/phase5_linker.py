#!/usr/bin/env python3
"""
phase5_linker.py — Link meeting_events to entity graph via event_participants.
...
Usage:
    PYTHONPATH=scripts python3 scripts/entities/phase5_linker.py
    PYTHONPATH=scripts python3 scripts/entities/phase5_linker.py --dry-run
    PYTHONPATH=scripts python3 scripts/entities/phase5_linker.py --limit 1000
    PYTHONPATH=scripts python3 scripts/entities/phase5_linker.py --reprocess
"""
...
log = logging.getLogger("phase5_linker")

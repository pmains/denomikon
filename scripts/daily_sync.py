...
TIER_2: list[list[str]] = [
    ...
    _daily_args("phoenix-rss", "--sync"),
    _daily_args("phoenix-aem", "--sync"),
    _daily_args("scottsdale", "--sync"),
    _daily_args("scottsdale-boards", "--sync"),
    ...
    _daily_args("fountain-hills", "--sync"),
...
TIER_3: list[list[str]] = [
    ...
    _weekly_args("phoenix-aem", "--sync"),
    _weekly_args("scottsdale", "--sync"),
    _weekly_args("scottsdale-boards", "--sync"),
    ...
    _weekly_args("fountain-hills", "--sync"),
